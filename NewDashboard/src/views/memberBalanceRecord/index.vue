  ...
  <div v-loading="dataLoading" class="view-container">
    <el-row class="seachForm">
      <el-form :inline="true" :model="searchForm">
        ...
        <el-form-item>
          <el-select v-model="searchForm.members" multiple filterable :placeholder="$t('__member')">
    ...
    >
      ...
      <el-table-column prop="member" :label="$t('__member')" align="center" :min-width="memberWidth" />
      ...
      <el-table-column prop="betOrderNumber" :label="$t('__orderNumber')" align="center" :min-width="betOrderNumberWidth" />
...
export default {
  ...
  computed: {
    ...
    memberWidth() {
      return this.calculateWidth(this.$t('__member'), 'member', 9) + 'px'
    },
    typeWidth() {
    ...
    betOrderNumberWidth() {
      return this.calculateWidth(this.$t('__orderNumber'), 'betOrderNumber', 9) + 'px'
    },
    operatorWidth() {
