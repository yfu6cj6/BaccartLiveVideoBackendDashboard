...
export const asyncRoutes = [
  {
    ...
    redirect: '/',
    name: 'backstage',
    meta: { title: '__backstage', icon: 'el-icon-document', permission: 1000 },
    children: [
      {
        path: 'accountList',
        name: 'AccountList',
        component: () => import('@/views/backstage/accountList/index'),
        meta: { title: '__accountList', icon: 'el-icon-user-solid', permission: 1001 }
      },
      {
        path: 'accountCreate',
        name: 'AccountCreate',
        component: () => import('@/views/backstage/accountCreate/index'),
        meta: { title: '__accountCreate', icon: 'el-icon-user-solid', permission: 1002 }
      },
      {
        path: 'roleGroup',
        name: 'RoleGroup',
